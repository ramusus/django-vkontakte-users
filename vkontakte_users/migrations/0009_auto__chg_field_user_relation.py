...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.relation'
        db.alter_column('vkontakte_users_user', 'relation', self.gf('django.db.models.fields.SmallIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'User.relation'
        db.alter_column('vkontakte_users_user', 'relation', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
