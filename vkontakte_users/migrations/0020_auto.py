...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'User', fields ['screen_name']
        db.create_index('vkontakte_users_user', ['screen_name'])

    def backwards(self, orm):
        # Removing index on 'User', fields ['screen_name']
        db.delete_index('vkontakte_users_user', ['screen_name'])
