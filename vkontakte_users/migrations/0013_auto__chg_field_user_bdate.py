...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.bdate'
        db.alter_column('vkontakte_users_user', 'bdate', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'User.bdate'
        db.alter_column('vkontakte_users_user', 'bdate', self.gf('django.db.models.fields.CharField')(max_length=20))
