...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.photo_medium_rec'
        db.add_column('vkontakte_users_user', 'photo_medium_rec', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)

        # Adding field 'User.photo_rec'
        db.add_column('vkontakte_users_user', 'photo_rec', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.photo_medium_rec'
        db.delete_column('vkontakte_users_user', 'photo_medium_rec')

        # Deleting field 'User.photo_rec'
        db.delete_column('vkontakte_users_user', 'photo_rec')
