...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.friends_count'
        db.add_column('vkontakte_users_user', 'friends_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'User.friends_count'
        db.delete_column('vkontakte_users_user', 'friends_count')
