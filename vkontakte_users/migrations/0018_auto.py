...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field friends_users on 'User'
        db.create_table('vkontakte_users_user_friends_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_user', models.ForeignKey(orm['vkontakte_users.user'], null=False)),
            ('to_user', models.ForeignKey(orm['vkontakte_users.user'], null=False))
        ))
        db.create_unique('vkontakte_users_user_friends_users', ['from_user_id', 'to_user_id'])

    def backwards(self, orm):
        # Removing M2M table for field friends_users on 'User'
        db.delete_table('vkontakte_users_user_friends_users')
    ...
    models = {
        ...
        'vkontakte_users.user': {
            ...
            'friends_users': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['vkontakte_users.User']", 'symmetrical': 'False'}),
