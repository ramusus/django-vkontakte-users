...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'vkontakte_users_user', u'id')


        # Changing field 'User.remote_id'
        db.alter_column(u'vkontakte_users_user', 'remote_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'User.id'
        db.add_column(u'vkontakte_users_user', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)


        # Changing field 'User.remote_id'
        db.alter_column(u'vkontakte_users_user', 'remote_id', self.gf('django.db.models.fields.BigIntegerField')(unique=True))
