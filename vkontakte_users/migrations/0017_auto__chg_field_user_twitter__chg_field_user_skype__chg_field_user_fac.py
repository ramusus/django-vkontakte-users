...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.twitter'
        db.alter_column('vkontakte_users_user', 'twitter', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'User.skype'
        db.alter_column('vkontakte_users_user', 'skype', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'User.facebook_name'
        db.alter_column('vkontakte_users_user', 'facebook_name', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'User.facebook'
        db.alter_column('vkontakte_users_user', 'facebook', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'User.livejournal'
        db.alter_column('vkontakte_users_user', 'livejournal', self.gf('django.db.models.fields.CharField')(max_length=500))
    def backwards(self, orm):

        # Changing field 'User.twitter'
        db.alter_column('vkontakte_users_user', 'twitter', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'User.skype'
        db.alter_column('vkontakte_users_user', 'skype', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'User.facebook_name'
        db.alter_column('vkontakte_users_user', 'facebook_name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'User.facebook'
        db.alter_column('vkontakte_users_user', 'facebook', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'User.livejournal'
        db.alter_column('vkontakte_users_user', 'livejournal', self.gf('django.db.models.fields.CharField')(max_length=50))
    models = {
