...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.is_deactivated'
        db.add_column(u'vkontakte_users_user', 'is_deactivated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.has_avatar'
        db.add_column(u'vkontakte_users_user', 'has_avatar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Removing index on 'User', fields ['photo_big']
        db.delete_index(u'vkontakte_users_user', ['photo_big'])


    def backwards(self, orm):
        # Adding index on 'User', fields ['photo_big']
        db.create_index(u'vkontakte_users_user', ['photo_big'])

        # Deleting field 'User.is_deactivated'
        db.delete_column(u'vkontakte_users_user', 'is_deactivated')

        # Deleting field 'User.has_avatar'
        db.delete_column(u'vkontakte_users_user', 'has_avatar')
    ...
    models = {
        ...
        u'vkontakte_users.user': {
            ...
            'is_deactivated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
