...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('vkontakte_users_user', 'activity', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'User.relation'
        db.add_column('vkontakte_users_user', 'relation', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True), keep_default=False)

        # Adding field 'User.wall_comments'
        db.add_column('vkontakte_users_user', 'wall_comments', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.activity'
        db.delete_column('vkontakte_users_user', 'activity')

        # Deleting field 'User.relation'
        db.delete_column('vkontakte_users_user', 'relation')

        # Deleting field 'User.wall_comments'
        db.delete_column('vkontakte_users_user', 'wall_comments')
    ...
    models = {
        ...
        'vkontakte_users.user': {
            ...
            'relation': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'}),
            'remote_id': ('django.db.models.fields.BigIntegerField', [], {'unique': 'True'}),
