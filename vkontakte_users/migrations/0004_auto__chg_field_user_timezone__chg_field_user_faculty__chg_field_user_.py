...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('vkontakte_users_user', 'timezone', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'User.faculty'
        db.alter_column('vkontakte_users_user', 'faculty', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'User.university'
        db.alter_column('vkontakte_users_user', 'university', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'User.timezone'
        db.alter_column('vkontakte_users_user', 'timezone', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'User.faculty'
        db.alter_column('vkontakte_users_user', 'faculty', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'User.university'
        db.alter_column('vkontakte_users_user', 'university', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
