...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.rate'
        db.alter_column('vkontakte_users_user', 'rate', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'User.rate'
        db.alter_column('vkontakte_users_user', 'rate', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
