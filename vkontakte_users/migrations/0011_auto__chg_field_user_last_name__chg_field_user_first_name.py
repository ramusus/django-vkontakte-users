...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('vkontakte_users_user', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'User.first_name'
        db.alter_column('vkontakte_users_user', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'User.last_name'
        db.alter_column('vkontakte_users_user', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'User.first_name'
        db.alter_column('vkontakte_users_user', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=100))
