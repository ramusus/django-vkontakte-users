...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'User', fields ['has_avatar']
        db.create_index(u'vkontakte_users_user', ['has_avatar'])

        # Adding index on 'User', fields ['is_deactivated']
        db.create_index(u'vkontakte_users_user', ['is_deactivated'])


    def backwards(self, orm):
        # Removing index on 'User', fields ['is_deactivated']
        db.delete_index(u'vkontakte_users_user', ['is_deactivated'])

        # Removing index on 'User', fields ['has_avatar']
        db.delete_index(u'vkontakte_users_user', ['has_avatar'])
    ...
    models = {
        ...
        u'vkontakte_users.user': {
            ...
            'has_avatar': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
