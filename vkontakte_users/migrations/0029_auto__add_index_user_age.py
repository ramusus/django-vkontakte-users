...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'User', fields ['age']
        db.create_index(u'vkontakte_users_user', ['age'])


    def backwards(self, orm):
        # Removing index on 'User', fields ['age']
        db.delete_index(u'vkontakte_users_user', ['age'])
    ...
    models = {
        ...
        u'vkontakte_users.user': {
            ...
            'age': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'db_index': 'True'}),
