...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.counters_updated'
        db.add_column('vkontakte_users_user', 'counters_updated', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.counters_updated'
        db.delete_column('vkontakte_users_user', 'counters_updated')
