...
class UserAdmin(VkontakteModelAdmin):
    ...
    list_display = ('image_preview', 'first_name', 'last_name', 'vk_link', 'rate', 'sex', 'bdate', 'timezone', 'city',
                    'country', 'has_mobile', 'home_phone', 'mobile_phone',)
    list_display_links = ('first_name', 'last_name')
    list_filter = ('sex', 'has_mobile')
